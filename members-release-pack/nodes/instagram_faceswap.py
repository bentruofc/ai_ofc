...
class InstagramFaceSwapNode:
    ...
    def run(
        ...
        print(f"\n{'═'*60}")
        print(f"{platform_icon}  AIORBUST {platform.upper()} FACE SWAP")
        ...
        # ── Instantiate NanoBananaAIO (reuse all face-swap methods) ───────────
        aio = NanoBananaAIO()
...
NODE_DISPLAY_NAME_MAPPINGS = {
    "InstagramFaceSwapNode": "Aiorbust Content Remaker",
}
