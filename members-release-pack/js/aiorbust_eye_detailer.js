...
// aiorbust_speed_hd_sampler.js), applied here to both nodes from
// aiorbust_eye_detailer.py for brand consistency across the pack.
const AIORBUST_DETAILER_CLASSES = ["AiorbustDetailer", "AiorbustEyeBBoxDetectorProvider"];

app.registerExtension({
    name: "aiorbust.EyeDetailer",
    nodeCreated(node) {
        if (!AIORBUST_DETAILER_CLASSES.includes(node.comfyClass)) return;
