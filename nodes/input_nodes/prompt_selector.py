...
def _get_prompt_files():
    """List .txt files in the prompts directory."""
...
try:
    ...
    @PromptServer.instance.routes.get("/prompt_selector_aiofc/get_prompts")
    ...
    @PromptServer.instance.routes.get("/prompt_selector_aiofc/get_prompts_by_file")
...
PromptSelectorNodeMonthly = PromptSelectorNode
...
NODE_DISPLAY_NAME_MAPPINGS = {
    "PromptSelectorNode": "Aiofc Prompt Selector",
    "PromptSelectorNodeMonthly": "Aiofc Prompt Selector",
}
