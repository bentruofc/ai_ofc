"""
ComfyUI node - Aiofc Video Frame Extractor.
...
class VideoFrameExtractorNode:
    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                "video_frames": ("IMAGE", {
                    "tooltip": "Connect the `video` output of Aiofc Image and Video Batch Loader.\n"
...
NODE_DISPLAY_NAME_MAPPINGS = {
    "VideoFrameExtractorNode": "Aiofc Video Frame Extractor",
}
