    ...
    def run(
        ...
        def _generate_for_scene(scene_frame):
            ...
            if ar == "auto":
                ...
                ar = NanoBananaAIO._detect_aspect_ratio(ref)
...
NODE_CLASS_MAPPINGS = {
    "ReposeCarouselNode": ReposeCarouselNode,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "ReposeCarouselNode": "AIOFC Re-pose for Carousel",
}
