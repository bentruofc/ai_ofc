"""
AIOFC Camera Look — camera pipeline simulation (numpy + PIL only).
"""
import io
import random
import math
...
class Aiofc_Camera_Look:
    """
    AIOFC Camera Look — physically inspired camera pipeline simulation.
    Order: sensor noise -> demosaic -> motion blur -> JPEG.
    """
        ...
        return {
            "required": {
                ...
                "demosaic_pixel_blur": ("FLOAT", {
                    ...
                    "tooltip": "Bayer pixel displacement (R/B channels shifted diagonally). 0 = disabled, 1 = natural ~1px sensor offset.",
                }),
                ...
                "kernel_motion_blur": ("FLOAT", {
                    ...
                    "tooltip": "Motion blur kernel width in pixels.",
                }),
