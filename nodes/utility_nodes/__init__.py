...
# Migrated utility nodes
from .aiofc_license import (
    NODE_CLASS_MAPPINGS as LICENSE_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as LICENSE_DISPLAY_MAPPINGS,
)
from .aiofc_eye_detailer import (
    NODE_CLASS_MAPPINGS as EYE_DETAILER_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as EYE_DETAILER_DISPLAY_MAPPINGS,
)
from .aiofc_speed_hd_sampler import (
    NODE_CLASS_MAPPINGS as SPEED_HD_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as SPEED_HD_DISPLAY_MAPPINGS,
)
from .aiofc_h3_frame_snap import (
    NODE_CLASS_MAPPINGS as H3_SNAP_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as H3_SNAP_DISPLAY_MAPPINGS,
)
from .aiofc_resolution_mp import (
    NODE_CLASS_MAPPINGS as RESOLUTION_MP_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as RESOLUTION_MP_DISPLAY_MAPPINGS,
)
from .image_enhancement import (
    NODE_CLASS_MAPPINGS as ENHANCEMENT_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as ENHANCEMENT_DISPLAY_MAPPINGS,
)
from .image_black_check import (
    NODE_CLASS_MAPPINGS as BLACK_CHECK_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as BLACK_CHECK_DISPLAY_MAPPINGS,
)
from .repose_carousel import (
    NODE_CLASS_MAPPINGS as REPOSE_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as REPOSE_DISPLAY_MAPPINGS,
)
from .instagram_faceswap import (
    NODE_CLASS_MAPPINGS as INSTAGRAM_FS_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as INSTAGRAM_FS_DISPLAY_MAPPINGS,
)
from .preview_image_no_metadata import (
    NODE_CLASS_MAPPINGS as PREVIEW_NO_META_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as PREVIEW_NO_META_DISPLAY_MAPPINGS,
)
from .metadata_bypass import (
    NODE_CLASS_MAPPINGS as METADATA_BYPASS_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as METADATA_BYPASS_DISPLAY_MAPPINGS,
)
from .image_processing import (
    NODE_CLASS_MAPPINGS as IMAGE_PROC_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as IMAGE_PROC_DISPLAY_MAPPINGS,
)
from .aiofc_apply_lut import (
    NODE_CLASS_MAPPINGS as APPLY_LUT_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as APPLY_LUT_DISPLAY_MAPPINGS,
)
from .aiofc_renoise import (
    NODE_CLASS_MAPPINGS as RENOISE_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as RENOISE_DISPLAY_MAPPINGS,
)
from .aiofc_camera_look import (
    NODE_CLASS_MAPPINGS as CAMERA_LOOK_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as CAMERA_LOOK_DISPLAY_MAPPINGS,
)
...
NODE_CLASS_MAPPINGS = {
    ...
    **LICENSE_MAPPINGS,
    **EYE_DETAILER_MAPPINGS,
    **SPEED_HD_MAPPINGS,
    **H3_SNAP_MAPPINGS,
    **RESOLUTION_MP_MAPPINGS,
    **ENHANCEMENT_MAPPINGS,
    **BLACK_CHECK_MAPPINGS,
    **REPOSE_MAPPINGS,
    **INSTAGRAM_FS_MAPPINGS,
    **PREVIEW_NO_META_MAPPINGS,
    **METADATA_BYPASS_MAPPINGS,
    **IMAGE_PROC_MAPPINGS,
    **APPLY_LUT_MAPPINGS,
    **RENOISE_MAPPINGS,
    **CAMERA_LOOK_MAPPINGS,
}
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    **LICENSE_DISPLAY_MAPPINGS,
    **EYE_DETAILER_DISPLAY_MAPPINGS,
    **SPEED_HD_DISPLAY_MAPPINGS,
    **H3_SNAP_DISPLAY_MAPPINGS,
    **RESOLUTION_MP_DISPLAY_MAPPINGS,
    **ENHANCEMENT_DISPLAY_MAPPINGS,
    **BLACK_CHECK_DISPLAY_MAPPINGS,
    **REPOSE_DISPLAY_MAPPINGS,
    **INSTAGRAM_FS_DISPLAY_MAPPINGS,
    **PREVIEW_NO_META_DISPLAY_MAPPINGS,
    **METADATA_BYPASS_DISPLAY_MAPPINGS,
    **IMAGE_PROC_DISPLAY_MAPPINGS,
    **APPLY_LUT_DISPLAY_MAPPINGS,
    **RENOISE_DISPLAY_MAPPINGS,
    **CAMERA_LOOK_DISPLAY_MAPPINGS,
}
