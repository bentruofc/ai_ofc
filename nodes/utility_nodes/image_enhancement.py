...
class ImageEnhancementNode:
    ...
    def run(
        ...
        if mode == "Soft":
            ...
            original_ar = NanoBananaAIO._detect_aspect_ratio(image)
...
NODE_CLASS_MAPPINGS = {
    "ImageEnhancementNode": ImageEnhancementNode,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "ImageEnhancementNode": "AIOFC Image Enhancement",
}
