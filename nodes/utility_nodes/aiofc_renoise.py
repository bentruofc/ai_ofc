...
try:
    ...
    print("⚠️ AIOFC Renoise: Kornia not found. Install with 'pip install kornia'.")
...
class Aiofc_Renoise:
    """
    AIOFC Renoise — Injects realistic digital sensor noise.
        ...
        return {
            "required": {
                ...
                "grain_size": ("FLOAT", {
                    ...
                    "tooltip": "Noise grain size. 1.0 = per-pixel noise. > 1 = larger grains. < 1 = finer grain.",
                }),
            },
        }
    ...
    def renoise(
        ...
        if shadow_emphasis > 0:
            luminance = kcolor.rgb_to_grayscale(img)
