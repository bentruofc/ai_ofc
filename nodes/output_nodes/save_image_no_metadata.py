...
class SaveImageNoMetadataNode:
    ...
    def save_images(self, images, filename_prefix="ComfyUI", format="PNG", quality=95):
        ...
        for batch_idx in range(images.shape[0]):
            ...
            logging.info("[AIOFC SaveNoMeta] Saved %s/%s", subfolder or "output", file)
            results.append({
                "filename": file,
                "subfolder": subfolder,
                "type": self.type,
...
SaveImageWithoutMetadata = SaveImageNoMetadataNode
...
NODE_DISPLAY_NAME_MAPPINGS = {
    "SaveImageNoMetadataNode": "AIOFC Save Image No Metadata",
    "SaveImageWithoutMetadata": "AIOFC Save Image Without Metadata (Legacy)",
}
