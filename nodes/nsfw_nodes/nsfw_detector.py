# ---
# ComfyUI AIOFC - NSFW Detector Node (v11.0 - UI Polish)
...
def download_model_if_missing(model_name="nudenet.onnx"):
    ...
    print(f"💨 AIOFC NSFW: Model '{model_name}' not found. Downloading...")
    ...
    try:
        ...
        print(f"✅ AIOFC NSFW: Model downloaded to {model_path}")
    except Exception as e:
        print(f"❌ AIOFC NSFW: Failed to download model. Error: {e}")
        if os.path.exists(model_path): os.remove(model_path)
        raise e

class AIOFC_NSFW_ModelLoader:
    ...
    RETURN_TYPES = ("NSFW_MODEL",); FUNCTION = "load_model"; CATEGORY = "AIOFC/NSFW"
...
class AIOFC_CensorLabels:
    ...
    RETURN_TYPES = ("CENSOR_LABELS",); FUNCTION = "get_censor_labels"; CATEGORY = "AIOFC/NSFW"
...
class AIOFC_NSFW_Detector:
    CLASS_MAP = AIOFC_CensorLabels.ID_MAP
    @classmethod
    ...
    RETURN_TYPES = ("STRING", "MASK", "STRING",); RETURN_NAMES = ("censored_detections_json", "detection_mask", "all_detections_json",); FUNCTION = "detect"; CATEGORY = "AIOFC/NSFW"
...
NODE_CLASS_MAPPINGS = { "AIOFC_NSFW_ModelLoader": AIOFC_NSFW_ModelLoader, "AIOFC_CensorLabels": AIOFC_CensorLabels, "AIOFC_NSFW_Detector": AIOFC_NSFW_Detector, }
NODE_DISPLAY_NAME_MAPPINGS = { "AIOFC_NSFW_ModelLoader": "💿 AIOFC NSFW Model Loader", "AIOFC_CensorLabels": "✅ AIOFC Censor Labels", "AIOFC_NSFW_Detector": "⚠️ AIOFC NSFW Detector", }