...
@PromptServer.instance.routes.post("/aiofc/generate_creative_prompts")
...
@PromptServer.instance.routes.options("/aiofc/generate_creative_prompts")
@PromptServer.instance.routes.options("/aiofc/generate_creative_prompts/")
...
@PromptServer.instance.routes.options("/aiofc/generate_character_description")
@PromptServer.instance.routes.options("/aiofc/generate_character_description/")
async def generate_character_description_options(request):
    return web.Response(headers=CORS_HEADERS)


@PromptServer.instance.routes.post("/aiofc/get_random_prompts")
