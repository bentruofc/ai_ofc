# ---
# ComfyUI AIOFC - Parallel Batch Generator Node
...
from .generative_api_nodes import MODEL_CONFIG, AIOFC_GenerativeAPIBase


class AIOFC_ParallelBatchGenerator(AIOFC_GenerativeAPIBase):
    """
...
NODE_CLASS_MAPPINGS = {
    "AIOFC_ParallelBatchGenerator": AIOFC_ParallelBatchGenerator,
}
