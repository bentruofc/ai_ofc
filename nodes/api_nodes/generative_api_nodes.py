# ---
# ComfyUI AIOFC - Generative API Nodes
...
class AIOFC_APITextToImage(AIOFC_GenerativeAPIBase):
    @classmethod
    def INPUT_TYPES(cls):
        return {
            "required": {
...
class AIOFC_APIImageToImage(AIOFC_GenerativeAPIBase):
    @classmethod
    def INPUT_TYPES(cls):
        return {
            "required": {
...
NODE_CLASS_MAPPINGS = {
    "AIOFC_APITextToImage": AIOFC_APITextToImage,
