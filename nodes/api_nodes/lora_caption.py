...
class LoraCaptionGeneratorNode:
    ...
    def process_folder(self, input_folder, api_key, provider, trigger_word,
        ...
        if provider == "vertex":
            ...
            if api_key.strip():
                LoraCaptionGeneratorNode._cached_api_key = api_key.strip()
            api_key = api_key.strip() or LoraCaptionGeneratorNode._cached_api_key
            if not api_key:
...
NODE_CLASS_MAPPINGS = {
    "LoraCaptionGeneratorNode": LoraCaptionGeneratorNode,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "LoraCaptionGeneratorNode": "Aiofc Lora Caption Generator",
}
