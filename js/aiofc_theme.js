...
// All Aiofc nodes — unified fire theme (with backward compatibility aliases)
const ALL_NODES = [
    // API nodes
    ...
    "H3ContextIR",
    // Input nodes
    "DirectoryImageLoaderNode",
    "AiofcImageBatchLoader",
    "AiorbustImageBatchLoader",
    "PromptSelectorNodeMonthly",
    // Output nodes
    "SaveImageNoMetadataNode",
    ...
    "AiorbustGroupToggle",
    // Utility nodes
    "MetadataRemoveNodeMonthly",
    "SaveAsPhonePhotoNodeMonthly",
    "Aiofc_Renoise",
    "Aiorbust_Renoise",
    "Aiofc_Camera_Look",
    ...
    "AiofcDetailer",
    "AiorbustDetailer",
    "AiofcEyeBBoxDetectorProvider",
    "AiorbustEyeBBoxDetectorProvider",
    "AiofcSpeedHDSampler",
    "AiorbustSpeedHDSampler",
];
...
app.registerExtension({
    ...
    nodeCreated(node) {
        ...
        if (
            node.comfyClass === "PreviewImageWithoutMetadata" ||
            node.comfyClass === "AiofcVideoLoader" ||
            node.comfyClass === "AiorBustVideoLoader" ||
            node.comfyClass === "NanoBananaAIO"
        ) {
            node.color      = "#3d2008";
            node.bgcolor    = "#1c1209";
            node.boxcolor   = "#e87a20";
