// ---
// Filename: ../ComfyUI_AIOFC/js/log.js
// ---
...
export class Log {
    ...
    static detail(s) {
        ...
        if (app.ui.settings.getSettingValue("AIOFC.Interactive.DetailedLogging")) Log.log(s)
    }
    static message_in(message, extra) {
        // Updated settings key
        if (!app.ui.settings.getSettingValue("AIOFC.Interactive.DetailedLogging")) return
