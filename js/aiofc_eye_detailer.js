...
// Same fire-particles-rising visual treatment used on the other Aiofc
// prompt/generation nodes (see ofm_prompt_generator.js / prompt_selector.js /
// aiofc_speed_hd_sampler.js), applied here to both nodes from
// aiofc_eye_detailer.py for brand consistency across the pack.
const AIOFC_DETAILER_CLASSES = [
    "AiofcDetailer",
    "AiorbustDetailer",
...
app.registerExtension({
    name: "aiofc.EyeDetailer",
    nodeCreated(node) {
        if (!AIOFC_DETAILER_CLASSES.includes(node.comfyClass)) return;
