// --- Filename: ../ComfyUI_AIOFC/js/boolean_bypass.js (FINAL, GROUP-BYPASS-AWARE VERSION) ---
...
app.registerExtension({
	name: "Comfy.AIOFC.BooleanBypass.Final.V4", // ​​​​​​​​​​‌‌​​​​​​​​​​​​​​‌‌​​​‌​​​​​​​​​‌​​‌​‌‌​​​​​​​​​‌​​​‌​‌​​​​​​​​​‌​‌​​​‌​​​​​​​​​​‌‌‌​​​​​​​​​​​​​‌‌​‌‌​​​​​​​​​​‌​​​​‌​​​​​​​​​​‌​‌​​​‌​​​​​​​​​‌​​‌‌‌​​​​​​​​​​‌​​​‌​​​​​​​​​​​‌​​​‌‌‌​​​​​​​​​‌​​​​‌​​​​​​​​​​​‌‌​​​​​​​​​​​​​‌​​​‌‌​​​​​​​​​​​‌‌‌​​‌​​​​​​​​​‌​​​‌‌‌​​​​​​​​​‌​‌​‌‌​​​​​​​​​​‌​​‌​‌‌​​​​​​​​​‌​​​‌​‌​​​​​​​​​‌​‌​​​​​​​​​​​​​​‌‌​‌‌​​​​​​​​​​​‌‌​‌​‌​​​​​​​​​​‌‌​​​​​​​​​​​​​​‌‌​​​‌​​​​​​​​​‌​‌​‌‌​‍

	async beforeRegisterNodeDef(nodeType, nodeData, app) {
		if (nodeData.name === "AIOFC_BooleanBypass") {
