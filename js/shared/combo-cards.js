...
export function renderComboCards(inputsWithImages, options = {}) {
    ...
    for (let idx = 0; idx < maxLen; idx++) {
            ...
            if (url) {
                return `
                    <div class="aiofc-combo-slot">
                        ...
                        <span class="aiofc-combo-slot-label">${input.label}</span>
                    </div>
                `;
            } else {
                return `
                    <div class="aiofc-combo-slot">
                        <div class="aiofc-combo-slot-image empty"></div>
                        <span class="aiofc-combo-slot-label">${input.label}</span>
                    </div>
                `;
            }
        ...
        html += `
            <div class="aiofc-combo-card">
                <div class="aiofc-combo-header">
                    <span class="aiofc-combo-number">#${idx + 1}</span>
                </div>
                <div class="aiofc-combo-slots">
                    ${slots}
                </div>
            </div>
        `;
